...
`,Jt=r.ZP.span`
  ...
  ${e=>{let{pos:t}=e;return t&&t>.535?r.iv`
        ...
        `:""}}
  text-indent: 0;
`,Kt=e=>{let{pos:t}=e;return i.createElement(Ot,null,i.createElement(qt,null,i.createElement(_t,null,i.createElement(V,{start:0,end:.08,pos:t,from:1,to:0},"So, since when were Bitcoin Maximalists all about node minimalism?"))),i.createElement(Lt,null,i.createElement(_t,null,i.createElement(V,{start:.08,end:.16,pos:t,from:0,to:1},"Since the block size wars, where it was revealed that any more liberal a stance than keeping block size as low as possible, for as long as possible while scaling Bitcoin, might be a centralizing force of evil.")),i.createElement(_t,null,i.createElement(V,{start:.16,end:.24,pos:t,from:0,to:1},"Years on from winning these wars, and preserving zero-cost-to-entry node architecture\u2014upon which all Hydra enabled HAB Nodes are explicitly reliant\u2014node minimalism remains just as important today as it ever was to ensure the lights stay on for Bitcoin."))),i.createElement(St,null,i.createElement(V,{start:.24,end:.32,pos:t,from:0,to:1},i.createElement(Nt,{pos:t}))),i.createElement(Yt,null,"But we are not here to merely keep the lights on, we are here to re-light civilization".split(" ").map(((e,n,r)=>i.createElement(V,{key:`${e}-${n}`,start:.1/r.length*n*2+.32,end:.1/r.length*(n+1)*2+.32,pos:t,from:0,to:1},i.createElement(V,{start:.54,end:.62,pos:t,from:1,to:0},"civilization"===e&&i.createElement(Xt,null,i.createElement(Jt,{pos:t},e)," "),"civilization"!==e&&i.createElement(Xt,null,e," ")))))),i.createElement(Rt,null,i.createElement(ie,{start:.75,end:1,pos:t,from:1,to:1.25},i.createElement(V,{start:.62,end:.7,pos:t,from:0,to:1},i.createElement(Tt,null,"Your Bitcoin Node")),i.createElement(It,null,"Composable Resilient Serene Distinguished Enduring Inimitable Tenacious Maximized Decentralized Fault-tolerant Highly_Available".split(" ").map(((e,n,r)=>i.createElement(Ct,{key:`${e}-${n}`},i.createElement(V,{key:`${e}-${n}`,start:.2/r.length*n+.7,end:.2/r.length*(n+1)+.7,pos:t,from:0,to:1},i.createElement(V,{start:.2/r.length*n+.2/r.length+.7,end:.2/r.length*(n+1)+.2/r.length+.7,pos:t,from:1,to:n===r.length-1?1:0},i.createElement(Gt,null,e.includes("_")?e.replace("_"," "):e))))))))),i.createElement(Ft,null,i.createElement(Bt,{start:.925,end:1,from:50,to:0,pos:t},i.createElement(Mt,null,i.createElement(Dt,{autoPlay:!0,loop:!0,muted:!0,playsinline:!0,preload:"none"},i.createElement("source",{src:"blue-node.mp4",type:"video/mp4"}))))))},Wt=r.ZP.div`
  display: grid;
  height: 100vh;
  width: 100vw;
  background: #f2a900;
...
`,zn=r.ZP.section`
  overflow-y: scroll;
  height: 100vh; 
`;function $n(){const e=(0,i.useRef)(null),[t,n]=(0,i.useState)(!1);return(0,i.useLayoutEffect)((()=>(t||setTimeout((function(){window.pageYOffset||(window.scrollTo(0,1),n(!0))}),1e3),()=>{n(!1)})),[e]),i.createElement(i.Fragment,null,i.createElement(d,null),i.createElement(Zn,null,i.createElement(f,null),i.createElement(zn,{ref:e},i.createElement(mn,{refOuter:e,child:kn,height:"300vh",minPos:0,maxPos:1.5}),i.createElement(mn,{refOuter:e,child:pe,height:"200vh",minPos:-1.5,maxPos:1.2}),i.createElement(mn,{refOuter:e,child:be,height:"200vh",maxPos:1.5}),i.createElement(mn,{refOuter:e,child:Ae,height:"150vh",minPos:0,maxPos:1}),i.createElement(mn,{refOuter:e,child:Le,height:"200vh",minPos:-.5,maxPos:2}),i.createElement(mn,{refOuter:e,child:Ue,height:"200vh",minPos:-2,maxPos:1.5}),i.createElement(mn,{refOuter:e,child:ot,height:"300vh",minPos:-.5,maxPos:1}),i.createElement(mn,{refOuter:e,child:Ht,height:"500vh",minPos:0,maxPos:1}),i.createElement(mn,{refOuter:e,child:B,height:"100vh",minPos:0,maxPos:0}),i.createElement(mn,{refOuter:e,child:an,height:"100vh",minPos:0,maxPos:0}),i.createElement(mn,{refOuter:e,child:te,height:"100vh",minPos:0,maxPos:0}),i.createElement(mn,{refOuter:e,child:pt,height:"100vh",minPos:0,maxPos:0}),i.createElement(mn,{refOuter:e,child:k,height:"100vh",minPos:0,maxPos:0}),i.createElement(mn,{refOuter:e,child:Kt,height:"600vh",minPos:0,maxPos:1.2}),i.createElement(mn,{refOuter:e,child:Y,height:"300vh",minPos:-.5,maxPos:1}))))}}}]);